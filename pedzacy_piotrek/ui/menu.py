...
class MenuScreen(Screen):
    ...
    def _start(self) -> None:
        ...
        config = SessionConfig(
            ...
            block_decision_seconds=self.settings_panel.block_decision_seconds,
            check_decision_seconds=self.settings_panel.check_decision_seconds,
            check_variant=self.settings_panel.check_variant,
            victory_variant=self.settings_panel.victory_variant,
            copy_consumes_use=self.settings_panel.copy_consumes_use,
